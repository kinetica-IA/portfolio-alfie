 ...
 * Opacity boosted ~50% for better visibility on light bg.
 */
...
export function PulseSymbol({ color = 'var(--sea)', size = 28, className = '' }) {
  return (
    ...
    >
      {/* Outer ring breathes */}
      <circle cx="14" cy="14" r="10" fill="none" stroke={color} strokeWidth="0.8" opacity="0.38">
        <animate attributeName="r" values="9;11;9" dur="3s" repeatCount="indefinite" />
        <animate attributeName="opacity" values="0.38;0.18;0.38" dur="3s" repeatCount="indefinite" />
      </circle>
      {/* ECG pulse line */}
      <polyline
      ...
      >
        ...
        <animate attributeName="opacity" values="0.3;0.85;0.85;0.3" dur="2.8s" repeatCount="indefinite" keyTimes="0;0.4;0.7;1" />
      </polyline>
      {/* Core dot */}
      <circle cx="14" cy="14" r="1.5" fill={color} opacity="0.7">
...
export function OrbitSymbol({ color = 'var(--teal)', size = 28, className = '' }) {
  return (
    ...
    >
      {/* Static ring */}
      <circle cx="14" cy="14" r="9" fill="none" stroke={color} strokeWidth="0.6" opacity="0.30" />
      {/* Orbiting dot 1 */}
      ...
      <circle r="1.2" fill={color} opacity="0.5">
        <animateMotion dur="4s" repeatCount="indefinite" begin="-2s" path="M14,5 A9,9 0 1,1 13.99,5" />
        <animate attributeName="opacity" values="0.5;0.25;0.5" dur="4s" repeatCount="indefinite" begin="-2s" />
      </circle>
      {/* Center */}
      <circle cx="14" cy="14" r="2" fill="none" stroke={color} strokeWidth="0.8" opacity="0.45">
  ...
  return (
    ...
    >
      ...
      >
        ...
        <animate attributeName="opacity" values="0.25;0.75;0.25" dur="3.5s" repeatCount="indefinite" />
      </path>
      {/* Signal dots at peaks */}
      <circle cx="7" cy="9" r="1.2" fill={color} opacity="0">
        <animate attributeName="opacity" values="0;0.7;0" dur="3.5s" repeatCount="indefinite" />
      </circle>
      <circle cx="17" cy="19" r="1.2" fill={color} opacity="0">
...
export function CellSymbol({ color = 'var(--warm)', size = 28, className = '' }) {
  return (
    ...
    >
      ...
      <ellipse cx="14" cy="14" fill="none" stroke={color} strokeWidth="0.8" opacity="0.38">
      ...
      {/* Nucleus */}
      <circle cx="14" cy="14" fill={color} opacity="0.22">
        <animate attributeName="r" values="4;4.8;4" dur="3s" repeatCount="indefinite" />
      </circle>
      {/* Internal organelles */}
      <circle cx="11" cy="12" r="1" fill={color} opacity="0.45">
      ...
      <circle cx="17" cy="15" r="0.8" fill={color} opacity="0.38">
...
export function NetworkSymbol({ color = 'var(--ice)', size = 28, className = '' }) {
  return (
    ...
    >
      {/* Connections */}
      <line x1="8" y1="8" x2="20" y2="12" stroke={color} strokeWidth="0.6" opacity="0.30">
        <animate attributeName="opacity" values="0.30;0.60;0.30" dur="3s" repeatCount="indefinite" />
      </line>
      <line x1="8" y1="8" x2="14" y2="22" stroke={color} strokeWidth="0.6" opacity="0.30">
        <animate attributeName="opacity" values="0.30;0.55;0.30" dur="3s" repeatCount="indefinite" begin="0.5s" />
      </line>
      <line x1="20" y1="12" x2="14" y2="22" stroke={color} strokeWidth="0.6" opacity="0.30">
        <animate attributeName="opacity" values="0.30;0.50;0.30" dur="3s" repeatCount="indefinite" begin="1s" />
      </line>
      {/* Nodes */}
      <circle cx="8" cy="8" r="2.5" fill={color} opacity="0.22">
        <animate attributeName="opacity" values="0.22;0.50;0.22" dur="3s" repeatCount="indefinite" />
      </circle>
      <circle cx="8" cy="8" r="1.2" fill={color} opacity="0.6" />
      <circle cx="20" cy="12" r="2" fill={color} opacity="0.18">
        <animate attributeName="opacity" values="0.18;0.45;0.18" dur="3s" repeatCount="indefinite" begin="0.5s" />
      </circle>
      <circle cx="20" cy="12" r="1" fill={color} opacity="0.6" />
      <circle cx="14" cy="22" r="2.2" fill={color} opacity="0.15">
        <animate attributeName="opacity" values="0.15;0.42;0.15" dur="3s" repeatCount="indefinite" begin="1s" />
      </circle>
      <circle cx="14" cy="22" r="1.1" fill={color} opacity="0.6" />
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="none" stroke={color} strokeWidth="1" opacity="0.50"
      ...
      {/* Cross-links */}
      <line x1="10" y1="6" x2="18" y2="6" stroke={color} strokeWidth="0.6" opacity="0.30">
        <animate attributeName="opacity" values="0.30;0.55;0.30" dur="3s" repeatCount="indefinite" />
      </line>
      <line x1="6" y1="14" x2="22" y2="14" stroke={color} strokeWidth="0.6" opacity="0.30">
        <animate attributeName="opacity" values="0.30;0.55;0.30" dur="3s" repeatCount="indefinite" begin="1s" />
      </line>
      <line x1="10" y1="22" x2="18" y2="22" stroke={color} strokeWidth="0.6" opacity="0.30">
        <animate attributeName="opacity" values="0.30;0.55;0.30" dur="3s" repeatCount="indefinite" begin="2s" />
      </line>
    </svg>
  )
}
