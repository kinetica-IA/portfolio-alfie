...
const CARDS = [
  ...
  },
  {
    ...
    color: 'var(--warm)',
    colorRgb: '196,133,90',
    desc: 'Full system documentation — 9-node graph, ALMA L1+L2 detail.',
    expandedDesc: 'Static HTML page with system diagram, per-node detail, ALMA layer breakdown, dependencies. Reads io3_state.json at runtime for live axiom counts and thresholds.',
