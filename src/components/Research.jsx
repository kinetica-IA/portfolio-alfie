...
const CARDS = [
  ...
  },
  {
    ...
    color: 'var(--warm)',
    colorRgb: '196,133,90',
    desc: 'Archived prototype — 9-node graph, ALMA L1+L2. Not in active development.',
    expandedDesc: 'Static HTML page with system diagram, per-node detail, ALMA layer breakdown, dependencies. Prototype dataset: 26 RAG chunks. Reads io3_state.json at runtime for live axiom counts and thresholds.',
    stats: 'ReAct loop · dual-model · archived',
